  ...
  return (
    <div className="w3-container mb-5" id="about">
      ...
      <p className="w3-center w3-xlarge">
        <b>Key features of our Project</b>
      </p>
      <div
      ...
      >
        <div
          className="w3-quarter mb-2 px-2 py-3 border-success"
        ...
        <div
          className="w3-quarter mb-2 px-2 py-3 border-danger"
          style={{ border: "1px solid black", borderRadius: "5%" }}
        >
        ...
        <div
          className="w3-quarter mb-2 px-2 py-3 border-info"
          style={{ border: "1px solid black", borderRadius: "5%" }}
        >
        ...
        <div
          className="w3-quarter px-2 py-3 border-primary"
          style={{ border: "1px solid black", borderRadius: "5%" }}
        >
